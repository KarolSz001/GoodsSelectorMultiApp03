...
public class ShoppingService {
    ...
    private Map<Customer, Map<Product, Long>> customersWithProducts = new HashMap<>();

    public ShoppingService(String... filenames) {
        if(filenames == null){
            throw new MyUncheckedException(" wrong args in ShoppingService constructor");
        }
    ...
    public void addCustomersWithProducts(CustomerWithProducts customerWithProducts){
        customersWithProducts.put(customerWithProducts.getCustomer(), (Map<Product, Long>) customerWithProducts.getProducts());
    }

    public void clearAllFromShoppingService(){
        customersWithProducts.clear();
    }
    public int getSize(){
        return customersWithProducts.size();
    }

    public Map<Customer, Map<Product, Long>> getCustomersWithProducts() {
    ...
    public Customer paidMostInSelectedCategory(Category category) {
        if (category == null) {
            throw new MyUncheckedException("null arg in method paidMostInSelectedCategory");
        }

        switch (category) {
            case BOOK:
                return customerWhoPaidMostInCategory(Category.BOOK);
            case ELECTRONIC:
                return customerWhoPaidMostInCategory(Category.ELECTRONIC);
            case FOOD:
                return customerWhoPaidMostInCategory(Category.FOOD);
            default:
                throw new MyUncheckedException("category is wrong");
        }
    }
    ...
    private Customer customerWhoPaidMostInCategory(Category cat) {
        if (cat == null) {
            throw new MyUncheckedException("null arg in method customerWhoPaidMostInCategory");
        }
